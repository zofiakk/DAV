...
This file contains the following functions:
    ...
    * make_scatter_c- creates the plot
...
def main():
    ...
    make_scatter_c(filtered_data, save=args.display,
                   fig_name="../images/fig3.png")


def make_scatter_c(data: pd.DataFrame, save: bool, fig_name: str):
    """Function which creates the scatter plot
    with dots instead of circles and added transparency
