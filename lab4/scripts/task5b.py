...
This file contains the following functions:
    ...
    * make_subplots_b- creates the plot
"""
...
def main():
    ...
    make_subplots_b(avg_city, save=args.display,
                   fig_name="../images/fig12.png")
    

def make_subplots_b(data:pd.DataFrame, save:bool, fig_name:str):
