...
This file contains the following functions:
    ...
    * make_scatter_a- creates the plot
...
def main():
    ...
    make_scatter_a(filtered_data, save=args.display,
                   fig_name="../images/fig1.png")


def make_scatter_a(data: pd.DataFrame, save: bool, fig_name: str):
    """Function which creates the basic scatter plot
    ...
    plt.scatter(x=data['year'], y=data['AverageTemperatureCelsius'], facecolors='none',
